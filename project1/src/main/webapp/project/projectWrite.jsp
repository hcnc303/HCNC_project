									...
									<div class="x_content">
										...
										<form id="demo-form2" name="frm" method="post" action="projectWriteSave.do" data-parsley-validate class="form-horizontal form-label-left">
											...
											<div class="item form-group">
												...
												<div class="col-md-6 col-sm-6 ">
													<input type="text" id="p_startdate" required="required" class="form-control" name="p_startdate">
												</div>
											</div>
											<div class="item form-group">
												...
												<div class="col-md-6 col-sm-6 ">
													<input type="text" id="p_enddate" required="required" class="form-control" name="p_enddate">
												</div>
											</div>
											<div class="item form-group">
