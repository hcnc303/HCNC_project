									...
									<div class="card-box table-responsive">
										...
										<table id="datatable-fixed-header" class="table table-striped table-bordered" style="width: 100%">
												...
												<c:forEach var="list" items="${sumList}">
													...
													<tr>
														<th>부족 인원</th>
														<td style="background-color: rgba(255, 158, 158, 0.3); color:red;">${list.dName - (list.jan+list.feb+list.mar+list.apr+list.may+list.jun+list.jul+list.aug+list.sep+list.oct+list.nov+list.dec)/12 }</td>
