					...
					<div class="x_panel">
						...
						<div class="x_content">
	                    	...
	                    	<div class="tab-content" id="myTabContent">
	                    		...
	                    		<div class="tab-pane fade show" id="sec" role="tabpanel" aria-labelledby="sec-tab">
									<div class="col-sm-12">
										<div class="card-box table-responsive">
											...
											<table id="datatable-fixed-header" class="table table-striped table-bordered" style="width: 100%">
												...
												<tbody>
													<c:forEach var="list" items="${monthList2}">
														<tr>
															<td>${list.pId }</td>
															<td>${list.pName }</td>												
															<td>
	                    		...
	                    		<div class="tab-pane fade show" id="thi" role="tabpanel" aria-labelledby="thi-tab">
									<div class="col-sm-12">
										<div class="card-box table-responsive">
											...
											<table id="datatable-fixed-header" class="table table-striped table-bordered" style="width: 100%">
												...
												<tbody>
													<c:forEach var="list" items="${monthList3}">
														<tr>
															<td>${list.pId }</td>
															<td>${list.pName }</td>												
															<td>
									...
									<div class="col-sm-12">
										<div class="card-box table-responsive">
											...
											<table id="datatable-fixed-header" class="table table-striped table-bordered" style="width: 100%">
												...
												<c:forEach var="list" items="${sumList3}">
													<tr style="background-color:rgba(255, 253, 124, 0.3);">
														<th>투입공수 평균</th>
														<td>
															${Math.round((list.jan+list.feb+list.mar+list.apr+list.may+list.jun+list.jul+list.aug+list.sep+list.oct+list.nov+list.dec)*10/12)/10}
